...
glColor3f(0,0,1);
 	...
 	glutBitmapString(GLUT_BITMAP_HELVETICA_18,(const unsigned char*)"Press I for Input,T for Translation,Y for Reflection along y,X for Reflection along x,R for rotation");
 Axes();
